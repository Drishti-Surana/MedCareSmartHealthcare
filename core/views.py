...
class CustomPasswordResetConfirmView(PasswordResetConfirmView):
    template_name = 'password_reset_confirm.html'  # Replace with your actual template name
    success_url = '/reset-password/done/'  # Replace with your desired success URL
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            with smtplib.SMTP(smtp_host, smtp_port) as smtp:
                ...
                smtp.sendmail(smtp_username, [email], email_message)
		
            # Send the password reset email
            send_mail(email_subject, email_message, '', [email])

        # Redirect the user to a confirmation or success page
        return render(request, 'password_reset_confirm.html')

    # Render the forgot password form template for GET requests
